  ...
  return (
    <Router>
      <Routes>
          ...
          element={
            <div className="App">
              <header className="App-header">
                {/* 应用的Logo和欢迎标题 */}
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/f/f7/Schneider_National_logo.svg"
                  alt="Schneider Logo"
                  className="app-logo"
                />
              ...
              <nav className="App-nav">
                ...
                <Link to="/about_us" className="nav-button">
                  About US
                </Link>
                <Link to="/community_tips" className="nav-button">
                  Community Tips
                </Link>
                <Link to="/driving_summary" className="nav-button">
                  Driving Summary
                </Link>
                <Link to="/community_support" className="nav-button">
                  Community Support
                </Link>
                ...
                <Link to="/maintenance_logs" className="nav-button">
        ...
        <Route
          path="/destination/confirmation"
          element={<DestinationConfirmation />}
        />
